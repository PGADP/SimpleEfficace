...
**If `has_context` is true (CONTEXT.md exists from discuss-phase) AND no `--research` flag:** Skip research — the user already discussed the phase scope and made decisions. Research is redundant when context is established. Skip to step 6.
