...
**If "Looks good":** Proceed to Step 3.6.

## 3.6. Brainstorming Gate (Light)

**Always propose a light brainstorming session before formalizing the milestone.**

A quick brainstorming helps discover additional features, challenge scope decisions, and prioritize effectively — especially when building on an existing codebase where assumptions from previous milestones may bias thinking.
...
Un brainstorming rapide peut aider à affiner le scope
du milestone et découvrir des opportunités.
```

Use AskUserQuestion:

- header: "Brainstorm"
- question: "Brainstorming rapide avant de formaliser le milestone ?"
- options:
  - "Brainstorm Light (10 min)" — Session focalisée : 20 idées ciblées pour affiner le scope et prioriser les features
  - "Skip" — Passer directement à la mise à jour de PROJECT.md
...
5. Extract outputs and integrate into milestone context:
   ...
   - **Insights** → add to milestone Key Context
...
When brainstorming was performed:
- **Step 4 (Update PROJECT.md):** Merge brainstorming insights into target features. Add reference to brainstorming document.
- **Step 9 (Define Requirements):** Use brainstorming priorities to inform category scoping. Brainstorming document listed as context for requirement generation.
...
<success_criteria>
- [ ] Brainstorming Light proposed (light/skip) — if performed, document saved to `.planning/brainstorming/` → **committed**
- [ ] PROJECT.md updated with Current Milestone section (including brainstorming insights if performed)
