...
| Concevoir / critiquer / polir du visuel | `~/.claude/se/vendor/design/impeccable/reference/<commande>.md` | 5-20 Ko |
| Avant toute édition d'UI | `~/.claude/se/vendor/design/impeccable/reference/craft-floor.md` | ~15 Ko |
| Respecter les conventions d'une plateforme | `~/.claude/se/vendor/design/platform-design-skills/skills/<plateforme>/rules/_sections.md` | ~40 Ko |
| Choisir une direction esthétique (projet vierge) | `~/.claude/se/vendor/design/ui-ux-pro-max/scripts/search.py` | exécuté, pas lu |
| Critères de verdict | `.planning/rules/ui-rules.json` du projet s'il existe, sinon `~/.claude/se/rules/ui-rules.json` | ~9 Ko |
...
2. **Une seule référence impeccable par tâche**, celle qui correspond au mode invoqué
   ...
   dans `~/.claude/se/vendor/design/impeccable/SKILL.src.md`.
3. Les fichiers `vendor/` sont **en lecture seule** — voir `~/.claude/se/vendor/design/README.md`.
